    ...
    <Fragment>
      {loader === false?
        <div>
          ...
          <button className="m-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded m-4">
            Ajouter une slide</button>
            <Link to={`/view-presentation/${currentPresentationId}`} className="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded-full">Voir</Link>
