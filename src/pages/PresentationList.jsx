                            ...
                            <div key={index} className="w-full flex space-x-4 m-4 shadow-md rounded-md">
                                <div className="flex flex-col justify-between p-4 leading-normal">
                                    ...
                                    <div className="flex items-right">
                                        <Link to={`/edit-presentation/${presentation.id}`} className="bg-blue-600 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded-full">Edit</Link>
                                        <Link to={`/view-presentation/${presentation.id}`} className="bg-yellow-700 hover:bg-yellow-500 text-white font-bold py-2 px-4 rounded-full">Voir</Link>
